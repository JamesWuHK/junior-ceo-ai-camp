...
- Critical asset cache diagnosis: EDGE_CACHE_STALE; stale canonical assets=2
...
- Stale canonical URLs: https://camps.wanli.wiki/robots.txt, https://camps.wanli.wiki/llms.txt
