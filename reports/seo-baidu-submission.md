...
- Private history file: seo/baidu-submit-history.json

## Summary

- Submission history status: WAITING_FOR_PRIVATE_SUBMISSION_HISTORY
- Total recorded submissions: 0
- Successful submissions: 0
- Failed submissions: 0
- Latest submitted at: N/A
- Latest URL count: 0
- Latest HTTP status: N/A

## Recent Submissions

Status | Submitted at | Site | HTTP | URL count | Response success/remain | Not same site | Not valid | Notes
--- | --- | --- | --- | --- | --- | --- | --- | ---
NO_DATA | N/A | N/A | N/A | 0 | N/A | 0 | 0 | No private Baidu submission history found.
