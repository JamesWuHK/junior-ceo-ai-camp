...
function seedDefaultCamp() {
  ...
  const pageSeeds = [
    ...
    ["team-formation", 1, "找到你的桌号", "activity", ["启动计时"], "找到老师分好的小组，看看今天一起出发的人"],
    ["team-formation", 2, "团队名称和方向", "activity", ["发布任务"], "给团队起名，讨论第一个想继续做的产品方向"],
    ["team-formation", 3, "团队名片亮相", "showcase", ["投屏展示"], "用一句话介绍团队名称和产品方向"],
    ...
    ["day1-reflection", 2, "带走一个 AI 判断方法", "activity", ["发布任务"], "写下今天最有用的一条判断方法"],
    ...
    ["demo-check", 3, "把 AI 跑偏改回来", "activity", ["发布任务"], "写下一次让 AI 改得更清楚的方法"],
