...
function seedDefaultCamp() {
  ...
  const modules = [
    ...
    ["team-building", 1, 2, "组建团队", "找到队友，起一个团队名", "09:40-10:00", "READY"],
    ["ai-judgement", 1, 3, "AI 基本原理与对话", "知道 AI 会读字、看图、生成，也要人来修改", "10:00-10:35", "READY"],
    ["workbuddy-webpage", 1, 4, "WorkBuddy 变网页", "看一句话怎样变成能点开的页面", "10:35-11:00", "READY"],
    ["team-formation", 1, 5, "创业知识输入：从一个小麻烦开始", "先看真实麻烦，再看产品怎样帮别人", "11:00-11:50", "READY"],
    ["track-cases", 1, 6, "选择赛道和真实用户", "团队选一条路，说清想帮谁", "13:30-14:20", "READY"],
    ["project-launch", 1, 7, "定下项目方向", "说清想帮谁，明天先做哪一步", "14:20-15:10", "READY"],
  ...
  const pageSeeds = [
    ...
    ["team-building", 1, "找到今天的队友", "teamwork", ["启动计时"], "看见今天一起做项目的伙伴，先坐到同一张桌子。"],
    ["team-building", 2, "给团队起一个名字", "teamwork", ["启动计时"], "名字短一点、好记一点，大家都愿意喊。"],
    ["team-building", 3, "团队亮个相", "experiment", ["发布任务"], "说出团队名和成员，让全班记住你们。"],
    ...
    ["team-formation", 1, "创业是什么？", "story", ["全屏演示"], "创业就是帮助别人解决问题，产生价值交换。"],
    ["team-formation", 2, "生活帮手：上学出门检查台", "story", ["全屏演示"], "早上出门前想不全，清单先帮同学少漏带一样东西。"],
    ["team-formation", 3, "学习工具：应用题拆题板", "story", ["全屏演示"], "长应用题一大段，先拆成能下手的几块。"],
    ["team-formation", 4, "创意工坊：四格漫画分镜台", "story", ["全屏演示"], "有故事点子，先排出四格草稿。"],
    ["team-formation", 5, "校园社区：校园活动组队板", "story", ["全屏演示"], "想参加活动，先找到同伴。"],
    ["team-formation", 6, "Demo：从故事里拆出产品", "demo", ["全屏演示"], "把用户、需求、产品、第一步、使用效果和价值交换拆开看。"],
    ["team-formation", 7, "轮到你：写帮忙卡", "experiment", ["发布任务", "启动计时"], "写下想帮谁、卡在哪、先帮哪一步、少掉什么麻烦。"],
    ["track-cases", 1, "四条赛道地图", "story", ["全屏演示"], "生活帮手、学习工具、创意工坊、校园社区，先选一条最想追的路。"],
    ["track-cases", 2, "选一条路，做自己的题", "experiment", ["发布任务"], "选主赛道，再写出自己团队想帮的人。"],
    ["track-cases", 3, "团队讨论：想帮谁", "teamwork", ["启动计时"], "把赛道变成一个真实用户和一个具体小麻烦。"],
    ["project-launch", 1, "团队讨论：定下今天要做的项目", "teamwork", ["启动计时"], "从刚才的故事和真实发现里，选一个最想继续做的小麻烦。"],
    ["project-launch", 2, "写清想帮的人", "teamwork", ["启动计时"], "这个人是谁？什么时候会卡住？最烦的是哪一步？"],
    ["project-launch", 3, "产品一句话", "teamwork", ["启动计时"], "我们做一个产品，帮谁在什么场景里少掉一个麻烦。"],
    ["project-launch", 4, "把团队方向放上来", "teamwork", ["发布任务"], "放上团队名、主赛道、想帮谁、卡点和产品一句话。"],
