...
function seedDefaultCamp() {
  ...
  const modules = [
    ...
    ["team-formation", 1, 3, "创业知识输入：从一个小麻烦开始", "先看真实麻烦，再看产品怎样帮别人", "10:35-11:25", "READY"],
    ["workbuddy-webpage", 1, 4, "WorkBuddy 变网页", "看一句话怎样变成能点开的页面", "11:25-11:50", "READY"],
    ["track-cases", 1, 5, "选择赛道和真实用户", "团队选一条路，说清想帮谁", "13:30-14:20", "READY"],
