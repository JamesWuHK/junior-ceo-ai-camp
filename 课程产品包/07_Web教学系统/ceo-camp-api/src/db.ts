...
function seedDefaultCamp() {
  ...
  const pageSeeds = [
    ...
    ["ai-judgement", 1, "你给 AI 三样东西", "story", ["全屏演示"], "照片。职业。要求。AI 才知道要画什么。"],
    ["ai-judgement", 2, "AI 一边看图，一边读字", "story", ["全屏演示"], "图告诉它长什么样，字告诉它要做什么。"],
    ["ai-judgement", 3, "线索清楚，AI 补得更像", "demo", ["全屏演示"], "你给的线索像拼图边缘，大模型接着补下一块。"],
    ["ai-judgement", 4, "这样问，DeepSeek 才帮得上忙", "demo", ["全屏演示"], "别只说“帮我想想”。说清帮谁、卡哪、先做哪一步。"],
    ["ai-judgement", 5, "轮到你：只填一个空", "experiment", ["发布任务"], "把你们的方向填进去，发给 DeepSeek 看看。"],
    ["ai-judgement", 6, "AI 说的，先分三堆", "experiment", ["发布任务"], "能做的留下。拿不准的去问同学。今天做不了的先放一边。"],
