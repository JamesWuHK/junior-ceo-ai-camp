...
<div class="slide"><h2>组合技 · 全流程展示</h2><p style="font-size:18px;margin-top:16px">老师全程不说话，纯看——</p><div class="demo-box" style="font-family:inherit;text-align:left;font-size:15px;line-height:2;margin-top:16px"><p>1. "帮我写一篇100字短文：如果猫会说话"</p><p style="color:rgba(255,255,255,.2)">→ 10秒，文章出来</p><p>2. "给这篇短文生成一张配图，卡通风格"</p><p style="color:rgba(255,255,255,.2)">→ 10秒，图出来</p><p>3. "把文字和图做成一个网页，暖色背景"</p><p style="color:rgba(255,255,255,.2)">→ 10秒，网页出来</p></div><div class="hint ask" style="margin-top:16px">提问</div><div class="hint-text">从写文章到出网页，用了多久？</div></div>
'''
...
slides += '''
<div class="slide"><h2 style="margin-bottom:16px">让 AI 写一封道歉信</h2><div class="letter-grid"><div class="letter-card"><div class="grade">差</div><p style="margin-bottom:8px;font-size:12px;color:rgba(255,255,255,.2)">"帮我写一封道歉信"</p><p>尊敬的[收信人]：我写这封信是为了表达我最诚挚的歉意。对于我的行为给您带来的不便，我深感抱歉...</p></div><div class="letter-card"><div class="grade" style="background:#888">中</div><p style="margin-bottom:8px;font-size:12px;color:rgba(255,255,255,.2)">"我是一个学生，写给老师的"</p><p>亲爱的老师：我想为我在课堂上的行为向您道歉...</p></div><div class="letter-card"><div class="grade great">好</div><p style="margin-bottom:8px;font-size:12px;color:rgba(255,255,255,.2)">"我是五年级的小明。上课讲话被王老师批评了。王老师嗓子都哑了还在讲课。用小孩的话写，200字以内"</p><p>王老师：我今天上课讲话，对不起。<b>您嗓子都哑了还在给我们讲课，我却跟同桌聊昨晚的游戏</b>。我保证明天开始...</p></div></div><div class="hint think" style="margin-top:12px">思考</div><div class="hint-text">第三次比第一次，你多做了什么？<br><span class="amber-text">同一个AI，问得好90分，问得差10分。中间差的80分，就是"说清楚"三个字。</span></div></div>
